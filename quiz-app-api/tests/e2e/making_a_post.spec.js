...
describe("making a post", function () {
  it("logs in and creates a new post", function () {
    ...
    // browser.pause() fill out and submit login form
    ...
    expect(element.all(by.css("ul.list-group li")).first().getText())
      ...
      .eventually
      .contain(post)
    // this is not passing the test as it checks for the one earlier post need to
    // look at the chai-as-promised documentation
